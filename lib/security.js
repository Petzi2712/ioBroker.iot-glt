...
const MODULES = ['alarms', 'visualization', 'trends', 'energy', 'editor', 'users'];
...
function defaultPermissions(role) {
  ...
  return Object.fromEntries(MODULES.map(module => [module, { read: admin || module !== 'users' && module !== 'editor', write: admin }]));
}
